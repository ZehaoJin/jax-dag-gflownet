...
if __name__ == '__main__':
    ...
    graphs = ['causal_BH_ell','causal_BH_len', 'causal_BH_spr']
    output_folders = ['output_ell','output_len', 'output_spr']
    for i in range(3):
        args.graph = graphs[i]
        args.output_folder = Path(output_folders[i])
        main(args)
